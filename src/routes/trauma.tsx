...
import heroImg from "@/assets/trauma-therapy.jpg.asset.json";
import processingImg from "@/assets/trauma-processing.jpg.asset.json";
import somaticImg from "@/assets/somatic-therapy.jpg.asset.json";
import stabilisationImg from "@/assets/stabilisation-safety.jpg.asset.json";
  ...
  head: () => ({
    meta: [
      { title: "Trauma Therapy — Dr. Exten Makwela" },
      {
        name: "description",
        content:
          "Specialised, compassionate trauma therapy with Dr. Exten Makwela. Evidence-based care to help you process traumatic experiences and rebuild safety.",
      },
      { property: "og:title", content: "Trauma Therapy — Dr. Exten Makwela" },
      {
...
const SESSIONS = [
  {
    ...
    subtitle: "Working through traumatic memories",
    image: processingImg.url,
  },
  {
    title: "Somatic Therapy",
    subtitle: "Releasing trauma from the body",
    image: somaticImg.url,
  },
  {
    title: "Stabilisation & Safety",
    subtitle: "Building coping and grounding skills",
    image: stabilisationImg.url,
  },
];
...
const FAQS = [
  {
    ...
    a: "We treat a wide range of trauma including physical abuse, sexual abuse, emotional abuse, neglect, domestic violence, accidents, natural disasters, crime-related trauma and complex trauma from ongoing adverse experiences.",
  },
  {
    q: "What is the difference between PTSD and complex trauma?",
    a: "PTSD typically results from a single traumatic event, while complex trauma develops from repeated, prolonged traumatic experiences, often in childhood. Complex trauma affects core identity and relationships more profoundly.",
  },
  {
    q: "What treatments are available for trauma?",
    a: "Evidence-based treatments include Trauma-Focused Cognitive Behavioural Therapy (TF-CBT), Eye Movement Desensitisation and Reprocessing (EMDR), Prolonged Exposure Therapy and Somatic approaches. Treatment is tailored to your specific needs and readiness.",
  },
  {
    q: "How long does trauma therapy usually take?",
    a: "Recovery is a gradual process. Some clients see improvement within 12 to 20 sessions, while others with complex trauma may benefit from longer-term therapy. We work at a pace that feels safe for you.",
  },
  {
    q: "When should I seek help for trauma?",
    a: "Seek help when trauma memories interfere with your daily life, relationships or ability to feel safe. Signs include flashbacks, nightmares, hypervigilance, avoidance and emotional numbness. Early intervention leads to better outcomes.",
  },
];
      ...
      <main className="soft-bg">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 py-14 md:py-20 grid lg:grid-cols-[320px_1fr] gap-10 lg:gap-16 items-start">
          ...
          <div className="space-y-16">
            <div>
              <h1 className="text-[2.5rem] md:text-[4rem] leading-[1.05]">Trauma Therapy</h1>
            ...
            <section>
              <h2 className="text-[2rem] md:text-[3rem]">About Trauma Services</h2>
              <p className="mt-6 text-text text-base md:text-lg leading-relaxed">
                Our Trauma Service provides specialised, compassionate care for individuals who
                have experienced traumatic events. We understand that trauma can leave lasting
                emotional and psychological scars. Our evidence-based approach helps you process
                your experiences in a safe, supportive environment. We work at your pace, helping
                you rebuild a sense of safety, trust and control over your life.
              </p>
            </section>
