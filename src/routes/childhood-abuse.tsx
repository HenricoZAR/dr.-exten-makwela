...
import heroImg from "@/assets/childhood-abuse-therapy.jpg.asset.json";
import processingImg from "@/assets/healing-from-past-abuse.jpg.asset.json";
import attachmentImg from "@/assets/attachment-repair.jpg.asset.json";
import compassionImg from "@/assets/self-compassion-work.jpg.asset.json";
...
export const Route = createFileRoute("/childhood-abuse")({
  head: () => ({
    meta: [
      { title: "Childhood Abuse Therapy — Dr. Exten Makwela" },
      {
        name: "description",
        content:
          "Compassionate, specialised therapy for adult survivors of childhood abuse with Dr. Exten Makwela. Evidence-based care to help you process and heal.",
      },
      { property: "og:title", content: "Childhood Abuse Therapy — Dr. Exten Makwela" },
      {
  ...
  component: ChildhoodAbuseTherapy,
});
...
const SESSIONS = [
  {
    ...
    subtitle: "Healing from past abuse memories",
    image: processingImg.url,
  },
  {
    title: "Attachment Repair",
    subtitle: "Rebuilding trust and connection",
    image: attachmentImg.url,
  },
  {
    title: "Self-Compassion Work",
    subtitle: "Developing kindness toward yourself",
    image: compassionImg.url,
  },
];

const FAQS = [
  {
    q: "What types of childhood abuse do you treat?",
    a: "We treat all forms of childhood abuse including physical abuse, sexual abuse, emotional abuse, psychological abuse, neglect and exposure to domestic violence. We also address complex trauma resulting from multiple forms of abuse.",
  },
  {
    q: "How does childhood abuse affect adults later in life?",
    a: "Adult survivors often struggle with low self-esteem, relationship difficulties, trust issues, anxiety, depression, dissociation and difficulty regulating emotions. Many also experience physical health problems and chronic stress responses.",
  },
  {
    q: "I don't remember my childhood clearly. Can therapy still help?",
    a: "Yes. Memory can be fragmented as a protective mechanism. Therapy helps you work with what you do remember, including emotional and body memories, without requiring you to recall every detail.",
  },
  {
    q: "What treatments are available for childhood abuse?",
    a: "Treatments include Trauma-Focused Cognitive Behavioural Therapy (TF-CBT), Eye Movement Desensitisation and Reprocessing (EMDR), psychodynamic therapy and somatic experiencing. Treatment is always paced to your comfort.",
  },
  {
    q: "When should I seek help for childhood abuse?",
    a: "Seek help when past abuse continues to affect your present life, relationships, emotional wellbeing or ability to function. Healing is possible at any stage of life and seeking support is a courageous step.",
  },
];
    ...
    <aside className="lg:sticky lg:top-28 self-start">
      <div className="rounded-[1.75rem] bg-alternate p-6 md:p-8">
        ...
        <ul className="mt-6 space-y-1">
          {SERVICES.map((s) => {
            const isActive = s === "Childhood Abuse";
...
function ChildhoodAbuseTherapy() {
  return (
      ...
      <main className="soft-bg">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 py-14 md:py-20 grid lg:grid-cols-[320px_1fr] gap-10 lg:gap-16 items-start">
          ...
          <div className="space-y-16">
            <div>
              <h1 className="text-[2.5rem] md:text-[4rem] leading-[1.05]">Childhood Abuse Therapy</h1>
              <div className="mt-8 overflow-hidden rounded-[2rem] aspect-[16/9] bg-alternate">
                <img
                  src={heroImg.url}
                  alt="Childhood abuse therapy support"
            ...
            <section>
              <h2 className="text-[2rem] md:text-[3rem]">About Childhood Abuse Services</h2>
              <p className="mt-6 text-text text-base md:text-lg leading-relaxed">
                Our Childhood Abuse Service provides compassionate, specialised care for adults who
                experienced abuse during their childhood years. We understand the profound and
                lasting impact that childhood abuse can have on your emotional wellbeing,
                relationships and sense of self. Our evidence-based approach helps you process
                painful memories in a safe, non-judgmental space where healing can truly begin.
              </p>
            </section>
